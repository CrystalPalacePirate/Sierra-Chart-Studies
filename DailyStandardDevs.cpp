...
//Plots daily standard deviations based on SET and IV. Calculates [-3...3] standard deviations. By default, only [-2...2] are plotted.

SCSFExport scsf_TestFunction(SCStudyInterfaceRef sc)
{
	...
	if (sc.SetDefaults)
	{
		...
		//Subgraph Defintion and Default Settings
